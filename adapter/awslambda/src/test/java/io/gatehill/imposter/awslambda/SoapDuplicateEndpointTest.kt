...
/**
 * Test SOAP matching when there are duplicate SOAP endpoints.
 */
class SoapDuplicateEndpointTest : AbstractHandlerTest() {
    private var handler: HandlerV2? = null

    override val configDir = "/soap-duplicate-endpoints/config"
    ...
    @ParameterizedTest
    @Event(value = "soap-duplicate-endpoints/requests/duplicate_endpoints.json", type = APIGatewayV2HTTPEvent::class)
