...
class OAS31Test : BaseVerticleTest() {
    ...
    @Test
    fun `successfully returns a response`() {
        ...
        RestAssured.given()
                ...
                .body("token", equalTo("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwiaWF0IjoxNTE2MjM5MDIyfQ.L8i6g3PfcHlioHCCPURC9pmXT7gdJpx3kOoyAfNUwCc"))
    }
}
