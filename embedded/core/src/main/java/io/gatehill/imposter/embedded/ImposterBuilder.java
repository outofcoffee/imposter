...
public class ImposterBuilder<M extends MockEngine, SELF extends ImposterBuilder<M, SELF>> {
    ...
    private static final String DISCOVERY_STRATEGY_FQCN = "io.gatehill.imposter.plugin.DynamicPluginDiscoveryStrategyImpl";
    ...
    private void configure(ImposterConfig imposterConfig, int port) {
        ...
        imposterConfig.setPluginDiscoveryStrategyClass(DISCOVERY_STRATEGY_FQCN);
