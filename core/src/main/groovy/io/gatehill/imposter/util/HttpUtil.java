...
import io.gatehill.imposter.server.VertxWebServerManagerImpl;
...
public final class HttpUtil {
    public static final String DEFAULT_SERVER_FACTORY = VertxWebServerManagerImpl.class.getCanonicalName();
