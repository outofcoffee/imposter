...
interface SecurityService {
     ...
     *
     *
     * If the request is to be denied, then this method sends HTTP 401 to the [RoutingContext].
     * If the request is to be permitted, no modification is made to the [RoutingContext].
     *
